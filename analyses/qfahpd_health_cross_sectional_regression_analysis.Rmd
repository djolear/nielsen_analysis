...
## Outcome: % of household calorie budget that goes to QFAHPD healthy categories
...
ggsave(
  "G:/My Drive/research/projects/niel/nielsen_relative_income/plots/grocery_spend_demog.png",
  qh_calories_monthly,
  width = 8,
  height = 6,
  dpi = 500
