...
li_upc <-
  read_csv("G:/My Drive/research/projects/niel/label_insights_data/label_insights_upc_sc_cal_only_021721.csv")
...
write_csv(products_master, paste0(machine_path, data_path, "products_master_imputed_calories_servings_conversion.csv"))
